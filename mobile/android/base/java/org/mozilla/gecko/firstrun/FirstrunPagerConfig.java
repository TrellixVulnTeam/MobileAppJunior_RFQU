   ...
   public static List<FirstrunPanelConfig> getDefault(Context context) {
    ...
    private static class SimplePanelConfigs {
        ...
        */
        ...
        public static final FirstrunPanelConfig welcome2PanelConfig = new FirstrunPanelConfig(FirstrunPanel.class.getName(),
                R.string.firstrun_panel_title_welcome2,
                R.drawable.firstrun_welcome3,
                R.string.firstrun_welcome3_message,
                R.string.firstrun_welcome3_subtext);
        public static final FirstrunPanelConfig privacyPanelConfig = new FirstrunPanelConfig(FirstrunPanel.class.getName(),
                R.string.firstrun_panel_title_privacy2,
                R.drawable.firstrun_efficiency,
                R.string.firstrun_privacy3_message,
                R.string.firstrun_privacy3_subtext);
        public static final FirstrunPanelConfig efficiencyPanelConfig = new FirstrunPanelConfig(LastPanel.class.getName(),
                R.string.firstrun_panel_title_efficiency,
                R.drawable.firstrun_privacy,
                R.string.firstrun_efficiency3_message,
                R.string.firstrun_efficiency3_subtext);
    }
}
